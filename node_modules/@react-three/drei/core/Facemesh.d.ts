...
export declare type MediaPipePoints = typeof FacemeshDatas.SAMPLE_FACE.keypoints | typeof FacemeshDatas.SAMPLE_FACELANDMARKER_RESULT.faceLandmarks[0];
...
export declare type FacemeshEyeProps = {
    side: 'left' | 'right';
    debug?: boolean;
};
export declare type FacemeshEyeApi = {
