...
__publicField(UnrealBloomPass, "BlurDirectionX", /* @__PURE__ */ new THREE.Vector2(1, 0));
__publicField(UnrealBloomPass, "BlurDirectionY", /* @__PURE__ */ new THREE.Vector2(0, 1));
