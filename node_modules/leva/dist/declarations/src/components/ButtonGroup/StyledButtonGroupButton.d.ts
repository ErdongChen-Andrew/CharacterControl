export declare const StyledButtonGroupButton: import("@stitches/react/types/styled-component").StyledComponent<"button", {}, {}, import("@stitches/react/types/css-util").CSS<{}, {
    colors: {
        elevation1: string;
        elevation2: string;
        elevation3: string;
